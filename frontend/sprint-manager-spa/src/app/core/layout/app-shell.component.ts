...
@Component({
  ...
  `,
  styles: [`
    .shell { min-height: 100vh; display: grid; grid-template-columns: 17rem 1fr; background: linear-gradient(180deg, #071018, #0b1721); color: #f6fbff; }
    .nav { padding: 1.5rem; border-right: 1px solid rgba(255,255,255,0.08); display: flex; flex-direction: column; gap: 2rem; }
    ...
    @media (max-width: 960px) {
      ...
      .nav { border-right: 0; border-bottom: 1px solid rgba(255,255,255,0.08); }
    }
  `]
})
